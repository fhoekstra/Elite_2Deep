...
weaponsets = {  # sets consisting of a primary and a secondary weapon
    'lasers': {
...
scenarios = {  # scenarios are sorted by playercount in a dict
    1: [  # the value of each playercount is a list of scenarios
        [{'x': 0, 'y': 0, 'phi': -_pi,  # each scenario is a list with props
            'vx': 0, 'vy': 800, 'vphi': 0, 'shape': talon,  # of ship idx (+1)
          },
         ]
    ],
...
# set default weapons for all scenarios: lasers
